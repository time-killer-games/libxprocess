...
if [ $(uname) = "Darwin" ]; then
  ...
  ar rc libxprocess.a gamemaker.o process.o xprocess.o && rm -f "gamemaker.o" "cocoa.o" "cproc.o" "xproc.o";
  ...
  ar rc libxprocess.a gamemaker.o process.o xprocess.o && rm -f "gamemaker.o" "cproc.o" "xproc.o";
elif [ $(uname) = "FreeBSD" ]; then
  clang++ -c gamemaker.cpp xprocess.cpp apiprocess/process.cpp -I. -shared -std=c++17 -I/usr/local/include -L/usr/local/lib -lprocstat -lutil -lc -lpthread -DPROCESS_GUIWINDOW_IMPL `pkg-config x11 --cflags --libs` -fPIC && clang++ gamemaker.o process.o xprocess.o -o libxprocess.so -I. -shared -std=c++17 -I/usr/local/include -L/usr/local/lib -lprocstat -lutil -lc -lpthread -DPROCESS_GUIWINDOW_IMPL `pkg-config x11 --cflags --libs` -fPIC;
  ar rc libxprocess.a gamemaker.o process.o xprocess.o && rm -f "gamemaker.o" "cproc.o" "xproc.o";
  ...
  g++ -c gamemaker.cpp xprocess.cpp apiprocess/process.cpp -I. -shared -std=c++17 -static-libgcc -lkvm -lc -lpthread -DPROCESS_GUIWINDOW_IMPL `pkg-config x11 --cflags --libs` -fPIC && g++ gamemaker.o process.o xprocess.o -o libxprocess.so -I. -shared -std=c++17 -lkvm -lc -lpthread -DPROCESS_GUIWINDOW_IMPL `pkg-config x11 --cflags --libs` -fPIC;
  ar rc libxprocess.a gamemaker.o process.o xprocess.o && rm -f "gamemaker.o" "cproc.o" "xproc.o";
else
  ...
  ar rc libxprocess.a gamemaker.o process.o xprocess.o && rm -f "apiprocess/process32.h" "apiprocess/process64.h" "gamemaker.o" "cproc.o" "xproc.o";
fi
