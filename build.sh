...
if [ $(uname) = "Darwin" ]; then
  ...
  g++ -c gamemaker.cpp lib/cproc/cproc.cpp lib/xproc/xproc.cpp -I. -shared -std=c++17 -static-libgcc -static-libstdc++ -static -DPROCESS_GUIWINDOW_IMPL && g++ gamemaker.o cproc.o xproc.o -o  libxprocess.dll -I. -shared -std=c++17 -static-libgcc -static-libstdc++ -static -lntdll -lDbghelp -DPROCESS_GUIWINDOW_IMPL;
